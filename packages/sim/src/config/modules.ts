...
export const MISSILE_PYLON: MissileModule = {
  ...
  boostTime: 0.55,
  turnRate: 1.25,
  // Срыв наступает при v⊥/d > seekerRate: ближе 40/0.35 ≈ 115 м от бочки с боковой
  // скоростью 40 м/с. Прямому полёту это не грозит — у него v⊥ = 0.
  seekerRate: 0.35,
  lifetime: 12,
}
...
export const MISSILE_HOMING: MissileModule = {
  ...
  boostTime: 0.5,
  turnRate: 1.1,
  /** Головка получше подвесной: срывается только с очень резкого манёвра. */
  seekerRate: 0.5,
  lifetime: 12,
}
...
export const MISSILE_HEAVY: MissileModule = {
  ...
  boostTime: 0.7,
  turnRate: 0.85,
  /** Тяжёлая и инертная: сбивается с наведения легче всех. */
  seekerRate: 0.28,
  lifetime: 14,
}
