...
/**
 * enterSystem очищает выбранную звезду. Поэтому при живом тоннеле null управляет
 * его размером, а любой индекс — новый приказ, даже если это дальнее устье старой пары.
 */
