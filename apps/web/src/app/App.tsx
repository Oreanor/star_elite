        ...
        <div
          ...
          style={{
            ...
            background: [
              ...
              // Гаснут к 11%, чтобы не подсвечивать нутро: горят именно два края, не пузырь.
              'radial-gradient(circle at 3% 50%, rgba(240,250,255,1) 0%, rgba(160,220,255,0.6) 4%, rgba(150,215,255,0) 11%)',
              'radial-gradient(circle at 97% 50%, rgba(240,250,255,1) 0%, rgba(160,220,255,0.6) 4%, rgba(150,215,255,0) 11%)',
              // Обод — ТОНКИЙ и ЧЁТКИЙ: резкий переход внутрь и наружу, без мягкого втекания
              // в центр (иначе мыльный пузырь). Узкая яркая полоска на 75% радиуса.
              'radial-gradient(ellipse at 50% 50%, transparent 71%, rgba(210,238,255,0.9) 75%, transparent 79%)',
            ].join(','),
