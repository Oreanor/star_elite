        ...
        <div
          ...
          style={{
            ...
            background: [
              ...
              // Быстро гаснут (к 16%), чтобы не подсвечивать нутро: горят именно два края.
              'radial-gradient(circle at 3% 50%, rgba(240,250,255,1) 0%, rgba(150,215,255,0.55) 7%, rgba(150,215,255,0) 16%)',
              'radial-gradient(circle at 97% 50%, rgba(240,250,255,1) 0%, rgba(150,215,255,0.55) 7%, rgba(150,215,255,0) 16%)',
              // Обод — тонкий и ТУСКЛЫЙ, только связать края дугой; нутро прозрачное.
              'radial-gradient(ellipse at 50% 50%, rgba(140,210,255,0) 60%, rgba(130,200,255,0.3) 71%, rgba(205,236,255,0.45) 75%, rgba(180,225,255,0) 85%)',
            ].join(','),
