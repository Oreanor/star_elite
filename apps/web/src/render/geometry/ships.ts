 ...
 *
 * И ГЛАВНОЕ, ЧТОБЫ НЕ ИСКАТЬ ЗДЕСЬ СНОВА: на кадры это НЕ ВЛИЯЕТ. Просадка 60 → 30 держалась
 * и на 256², то есть при бюджете в шестьдесят раз меньше. Видеопамять тут ни при чём, ищи в
 * заливке пикселей (полное разрешение окна + блум + логарифмическая глубина). Ужимаем не ради
 * кадров, а ради гигабайта, который иначе занят зря.
 *
