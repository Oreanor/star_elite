...
export const EN: Record<keyof typeof RU, string> = {
  ...
  'key.cruiseLatch': 'Alt',
  'key.cruiseLatch.what': 'latch afterburner: freeze; Space again resumes spool',
  'key.fire': 'LMB',
  ...
  'key.retarget': 'Q',
  'key.retarget.what': 'nearest in Tab circle',
  'key.clearNav': 'Shift+Q',
  'key.clearNav.what': 'nearest in Shift+Tab circle',
  'key.autofight': 'P',
  ...
  'hud.crash': 'CRASH',
  'hud.crashHit': 'CRASH · {kind} {name}',
  'hud.crashHitAnon': 'CRASH · {kind}',
  'hud.shipLost': 'SHIP LOST',
  'hud.shipLostHit': 'SHIP LOST · {kind} {name}',
  'hud.shipLostAnon': 'SHIP LOST · {kind}',
  'hud.refuel': 'SCOOPING',
  'hud.throttle': 'THRT',
  'hud.rockets': 'MSL',
  ...
  'hud.cruiseLatch': 'AFTERBURNER LATCHED',
  'hud.cruiseUnlatch': 'MANUAL BRAKE',
  ...
  'map.block.scaled': 'HYPERJUMP REQUIRES 1× SCALE',
  'map.pickStation': '{n} docks — pick where to arrive',
  'planet.surface.rocky': 'rocky',
  'planet.surface.ice': 'ice',
  'planet.surface.gas': 'gas giant',
  'planet.surface.ocean': 'ocean',
  'planet.surface.terra': 'earth-like',
  'planet.type': 'TYPE',
  ...
  'planet.day': 'DAY',
  'planet.year': 'YEAR',
  'planet.orbit': 'FROM STAR',
  'planet.moons': 'MOONS',
  'planet.none': 'none',
  'planet.earthMass': '{n} Earth masses',
  'planet.hours': '{n} h',
  'planet.days': '{n} d',
  'map.label.pilot': 'PILOT',
  'map.label.profession': 'TRADE',
