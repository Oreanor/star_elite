...
export const IT: Record<keyof typeof RU, string> = {
  ...
  'key.missile': 'R',
  'key.missile.what': 'missile sul bersaglio',
  'key.aux': 'E',
  ...
  'hud.landPrompt': 'L — ATTERRA · QUOTA {alt}',
  'hud.refuel': 'RACCOLTA',
  'hud.throttle': 'SPNT',
  'hud.rockets': 'MSL',
  ...
  'station.hold.empty': 'Vuota. Abbatti un pirata e recupera la capsula — arriva da sola se ti avvicini piano.',
  'station.sell': 'VENDI',
  ...
  'map.jump': 'BALZO',
  'map.jumpGalaxy': 'VERSO UN\'ALTRA GALASSIA',
