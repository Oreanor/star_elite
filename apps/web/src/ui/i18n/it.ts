...
export const IT: Record<keyof typeof RU, string> = {
  ...
  'menu.loadingGfx': 'CARICO GRAFICA…',
  ...
  'key.retarget': 'Q',
  'key.retarget.what': 'reset → più vicino stessa classe',
  'key.autofight': 'P',
  ...
  'map.jump': 'H — iperspazio',
  'map.jumpGalaxy': 'H — verso un\'altra galassia',
  ...
  'map.noPlanets': 'Nessun pianeta. Niente dove andare se non la stella stessa.',
