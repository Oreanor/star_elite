...
export const DE: Record<keyof typeof RU, string> = {
  ...
  'key.retarget': 'Q',
  'key.retarget.what': 'Reset → nächstes gleicher Klasse',
  'key.autofight': 'P',
  ...
  'map.jump': 'H — Hyperraum',
  'map.jumpGalaxy': 'H — in eine andere Galaxie',
  ...
  'map.noPlanets': 'Keine Planeten. Nichts anzufliegen außer dem Stern selbst.',
