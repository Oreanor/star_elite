...
export const DE: Record<keyof typeof RU, string> = {
  ...
  'key.missile': 'R',
  'key.missile.what': 'Rakete auf Ziel',
  'key.aux': 'E',
  ...
  'hud.landPrompt': 'L — AUTOLANDUNG · HÖHE {alt}',
  'hud.refuel': 'SCHÖPFEN',
  'hud.throttle': 'SCHUB',
  'hud.rockets': 'RKT',
  ...
  'station.hold.empty': 'Leer. Schieß einen Piraten ab und schöpf die Kapsel — sie kommt von allein, näherst du dich leise.',
  ...
  'map.jump': 'SPRUNG',
  'map.jumpGalaxy': 'IN EINE ANDERE GALAXIE',
